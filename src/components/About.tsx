  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-[var(--fg)] text-center mt-10 md:mb-12">
          <BlurText
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start md:items-stretch">
          <div className="order-2 md:order-1 flex flex-col items-center gap-6">
                  ...
                  <div className="flex justify-between w-full text-xs text-white/80">
                    <div>{time}</div>
                      ...
                      <svg
                        ...
                        aria-hidden="true"
                      >
                        <rect x="3" y="14" width="3" height="7" rx="0.5" fill="currentColor" />
                        <rect x="8" y="11" width="3" height="10" rx="0.5" fill="currentColor" />
                        <rect x="13" y="8" width="3" height="13" rx="0.5" fill="currentColor" />
                        <rect x="18" y="5" width="3" height="16" rx="0.5" fill="currentColor" />
                      </svg>
                      <svg
                        className="w-4 h-4"
                        viewBox="0 0 24 24"
                      ...
                      >
                        <path
                          d="M4 9c2.4-2 5.6-3 8-3s5.6 1 8 3"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="1.4"
                          strokeLinecap="round"
                        />
                        <path
                          d="M7 12c1.8-1.4 4-2.1 5-2.1s3.2.7 5 2.1"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="1.4"
                          strokeLinecap="round"
                        />
                        <path
                          d="M9.5 14.5c.8-.6 1.6-.9 2.5-.9s1.7.3 2.5.9"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="1.4"
                          strokeLinecap="round"
                      ...
                      >
                        ...
                        <rect x="21.5" y="10" width="2" height="4" rx="0.7" fill="currentColor" />
                      </svg>
                    </div>
                  </div>
            ...
            <div className="relative w-full max-w-[320px]">
              <div className="md:hidden pointer-events-none bg-gradient-to-r from-[var(--bg)] via-[var(--bg)] to-transparent absolute z-20 w-10 rounded-md h-full left-0 -ml-4" />
              <div className="flex w-full gap-2 py-1 px-1 text-xs">
                  ...
                  CHAT_ITEMS.map((item, index) =>
                    availableQuestions.includes(index) ? (
                      <button
                        ...
                        className="relative flex-1 rounded-full bg-[var(--accent)] hover:bg-[var(--accent)]/90 active:bg-[var(--accent)]/95 px-3 py-2 text-xs leading-snug text-white text-center font-semibold transition-colors"
                      >
                        {t(item.q)}
                      </button>
                    ) : null
              ...
              <div className="md:hidden pointer-events-none bg-gradient-to-r from-[var(--bg)] via-[var(--bg)] to-transparent absolute z-20 w-10 rounded-md h-full right-0 rotate-180 -mr-4" />
            </div>
          </div>

          <div className="order-1 md:order-2 flex flex-col gap-4 w-full max-w-xl mx-auto md:mx-0 text-center md:text-left h-full min-h-0">
            ...
            <div className="flex-1 min-h-0 w-full max-w-prose flex flex-col gap-4 text-left mt-4 md:mt-6">
              {paragraphs.map((paragraph, index) => {
                if (index < currentParagraph) {
                  return (
                    <p key={index} className="text-base md:text-lg font-semibold text-[var(--fg)] leading-relaxed">
                      {paragraph}
                    </p>
                  )
                }
