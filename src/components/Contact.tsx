...
const LINKS = [
  { name: 'Mail', url: 'mailto:hboissard23@gmail.com', img: '/assets/Mail.svg' },
  { name: 'LinkedIn', url: 'https://linkedin.com/in/hedi-boissard-a994ab25b', img: '/assets/Linkedin.svg' },
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto flex flex-col gap-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-[var(--fg)] mb-0">
          <BlurText
          ...
          {LINKS.map((l) => (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-white/10 border border-white flex items-center justify-center transition-colors">
                <img src={l.img} alt="" className="w-5 h-5 invert brightness-0 opacity-100" />
              </div>
        ...
        <div className="w-full max-w-3xl mx-auto rounded-3xl bg-[#020617]/90 border border-white/5 shadow-[0_20px_45px_rgba(15,23,42,0.85)] px-5 py-6 md:px-8 md:py-7">
          ...
          <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 text-sm md:text-base font-semibold rounded-xl bg-gradient-to-r from-sky-500 to-sky-400 text-white shadow-[0_16px_30px_rgba(56,189,248,0.6)] hover:brightness-110 disabled:opacity-60 transition"
            >
